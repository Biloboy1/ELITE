...
\033[1;32m
\x1b[1;97m------------------------🔸LOGIN🔸------------------------
\x1b[1;95mAu : Ghostson
\x1b[1;95mWa : +2349138017570
\33[1;96mFb : facebook.com/Anonymous
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				...
				if 'no' in taplikasi:
					...
					for muncul in apkKadaluarsa:
						hit1+=1
						infoakun += (f"[bold green][{hit1}] {muncul} {kadaluarsa[hit2]}[/bold green]\n")
					print(f'\r  {H}OK✅ {idf}|{pw}|{N}{kuki}{infoakun}')
					break
